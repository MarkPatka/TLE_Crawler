...
public interface ITLEDBFactory
{
    ...
    public Task<int> ExecuteStoredProcedureAsNonQueryAsync(SqlConnection connection, string procedureName, SqlParameter[] sqlParameters, SqlTransaction? transaction = null);
}
